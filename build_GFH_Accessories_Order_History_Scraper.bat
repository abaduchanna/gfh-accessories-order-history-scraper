...
REM    2. Double-click build_GFH_Accessories_Order_History_Scraper.bat, OR run from Command Prompt
...
set "WORKBASE=%TEMP%\pyi_build\GFH-Accessories-Order-History-Scraper"
